...
RSpec.describe Junction::RolesController, type: :routing do
  describe "routing" do
    it "routes to #index" do
      expect(get: "/roles").to route_to("junction/roles#index")
    end

    it "routes to #new" do
      expect(get: "/roles/new").to route_to("junction/roles#new")
    end
    ...
    it "routes to #create" do
      expect(post: "/roles").to route_to("junction/roles#create")
    end
