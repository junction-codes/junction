...
RSpec.shared_examples "a model that can be depended on" do
  describe 'dependable associations' do
    ...
    it { is_expected.to have_many(:target_relations).dependent(:destroy) }
