  ...
  module Views
    module Sessions
      ...
      class New < Views::Base
                ...
                div(class: "p-6 space-y-4 md:space-y-6 sm:p-8") do
                  ...
                  form_with(url: session_url, class: "space-y-4 md:space-y-6", action: "#") do |form|
                    ...
                    div(class: "flex items-center justify-between") do
                      a(href: new_password_path, class: "text-sm font-medium text-primary-600 hover:underline dark:text-primary-500") { plain t(".forgot") }
                    end
        ...
        def provider_logins
          return unless Junction::PluginRegistry.auth_providers.any?
