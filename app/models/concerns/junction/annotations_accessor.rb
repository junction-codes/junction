...
module Junction
  ...
  class AnnotationsAccessor
    ...
    # @param default [Object] The default value to return if the key is not
    #   found.
    ...
    #
    # We do not define `respond_to_missing?` because we want to treat this
    # object more like a hash than a rigid object. The primary access method for
    # complex keys will remain the `[]` method.
