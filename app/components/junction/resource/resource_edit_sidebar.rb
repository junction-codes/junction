...
module Junction
  module Components
    class ResourceEditSidebar < Base
      def initialize(resource:, can_destroy: true)
        @resource = resource
              ...
              render Dialog do |dialog|
                ...
                dialog.content do |content|
                  ...
                  content.footer do
                    ...
                    render Link.new(variant: :destructive, href: resource_path(@resource), data_turbo_method: :delete) { "Confirm Delete" }
                  end
                end
              end
            end
